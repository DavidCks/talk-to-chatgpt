...
function CN_KeepSpeechRecWorking() {
  ...
  if (!CN_IS_READING && !CN_IS_LISTENING && !CN_PAUSED) {
    if (!CN_SPEECHREC && !CN_IS_READING) ;else {
...
function CN_InitScript() {
  ...
  // Action buttons
  "<div style='font-size: 20px; padding: 12px 8px; padding-bottom: 6px; display:none;' class='CNActionButtons'>" + "<table width='100%' cellpadding=0 cellspacing=0><tr>" +
  ...
  "<td width='24%' style='text-align: center;'>" + "<span class='CNToggle' title='Text-to-speech (bot voice) enabled. Click to disable. This will skip the current message entirely. (Shortcut: ALT+SHIFT+V)' data-cn='speakon' style='opacity: 0.7;'><i class=\"fa-solid fa-volume-high\"></i></span>" +
  // Speak out loud
  ...
  // Mute
  "</td>" + "<td width='1%' style='border-left: 1px solid grey; padding-left: 0 !important; padding-right: 0 !important; font-size: 1px;'>&nbsp;</td>" + "<td width='24%' style='text-align: center;'>" + "<span class='CNToggle' title='Skip the message currently being read by the bot. (Shortcut: ALT+SHIFT+L)' data-cn='skip' style='opacity: 0.7;'><i class=\"fa-solid fa-angles-right\"></i></span>" +
  // Skip
  "</td>" + "<td width='1%' style='border-left: 1px solid grey; padding-left: 0 !important; padding-right: 0 !important; font-size: 1px;'>&nbsp;</td>" + "<td width='24%' style='text-align: center;'>" + "<span class='CNToggle' title='Open settings menu to change bot voice, language, and other settings' data-cn='settings' style='opacity: 0.7;'><i class=\"fa-solid fa-sliders\"></i></span>" +
  // Settings
  "</td>" + "</tr></table>" +
